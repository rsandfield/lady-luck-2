...
#func _process(_delta: float) -> void:
	#if Game.global_confetti_points != 0: 
		#var _confetti_points = Game.global_confetti_points
		#Game.global_confetti_points = 0
		#_on_new_confetti(_confetti_points)
		#print_debug("why not working...")
