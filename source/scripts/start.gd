...
func _update_music() -> void:
	$InterfaceContainer/SoundControl/MusicButton/Music1/Panel.visible = (
		Data.setting_music_type == 1
	)
	$InterfaceContainer/SoundControl/MusicButton/Music2/Panel.visible = (
		Data.setting_music_type == 2
	)
	$InterfaceContainer/SoundControl/MusicButton/Music3/Panel.visible = (
		Data.setting_music_type == 3
	)
